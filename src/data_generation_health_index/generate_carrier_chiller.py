...
# --- Configuration ---
MACHINE_TYPE = "carrier_chiller" # <-- Changed
TARGET_ROWS = 200_000
...
if __name__ == "__main__":
    ...
    while total_rows_generated < TARGET_ROWS:
        ...
        # Carrier Chiller: No specific cycle mentioned in original config, adding a placeholder
        # Add ambient temperature influence on condenser_temp?
        segment_data = apply_cyclical_pattern(timestamps, segment_data, "condenser_temp",
                                              amplitude=0.05, period_hours=24, start_date=global_start_time)
        # ------------------------------------------------- #
