...
if __name__ == "__main__":
    ...
    while total_rows_generated < TARGET_ROWS:
        ...
        # HAAS CNC: Work shift pattern on spindle load
        segment_data = apply_cyclical_pattern(timestamps, segment_data, "spindle_load",
                                              amplitude=0.25, period_hours=8, start_date=global_start_time)
        # ------------------------------------------------- #
